...
import { Heart, Sparkles, Lock, Mail, ArrowLeft, AlertCircle, CheckCircle, Star } from 'lucide-react';
...
const Login = () => {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      setForgotMessage('Email de réinitialisation envoyé !');
      setTimeout(() => {
                ...
                <>
                  ...
                  {forgotMessage && (
                    <div className="mb-6 p-4 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl flex items-start gap-3 shadow-sm">
                      ...
                      <p className="text-green-700 text-sm font-medium">{forgotMessage}</p>
                    </div>
                  )}
                  ...
                  <form onSubmit={handleForgotPassword} className="space-y-5">
                    ...
                    <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-white py-4 rounded-full font-bold shadow-lg hover:shadow-2xl transition-all hover:scale-105 flex items-center justify-center gap-2 mt-6 relative overflow-hidden group"
                    >
