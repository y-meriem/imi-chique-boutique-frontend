                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      disabled={loading}
                      className="w-full pl-12 pr-4 py-3.5 rounded-xl border-2 border-pink-200 focus:border-pink-400 focus:outline-none bg-white text-gray-800 shadow-sm transition-all hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                    />
                  </div>
                </div>
